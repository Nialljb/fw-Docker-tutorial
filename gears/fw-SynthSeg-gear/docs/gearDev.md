...
This new tool facilitates downloading a gear from Flywheel after it has been uploaded as an image so you can work inside it as a container to debug interactivly. This simplies the process substantially as you can check the structure/paths as it runs on the platform.
...
- The API key can be found in your profile on the platform & saved in shell startup script (.zshrc, .bash_profile)
